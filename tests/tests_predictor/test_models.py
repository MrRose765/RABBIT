def test_load_model():
    ...
    """
    from rabbit.predictor.models import load_model
...
def test_predict_contributor():
    ...
    """
    from rabbit.predictor.models import load_model, predict_contributor
    import os
    import pandas as pd
    ...
    prediction, confidence = predict_contributor(sample_bot_features, load_model())
